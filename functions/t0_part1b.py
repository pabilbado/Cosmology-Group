...
"""
t0_part1bintegrand class: calculates the integrand of the expression for the age of the universe t0, for a given
...
class t0_part1b(Function):
    ...
    def cal(self, PomeM):
        ...
        #integrate from a default lower limit of 1e-5, and an integration step of 1e-3
