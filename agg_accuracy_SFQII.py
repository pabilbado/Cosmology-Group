...
agg1 = agg_accuracy()
agg1.d.update(factor=1, at=0.23, tau=0.33, wpast=0, wf=-1)
...
fig.savefig('plot_agg_acc_PT2_SFQII.pdf')

#print aggregate accuracy at z=0.5 and z=1.32
print('SFQ-II (z = ' + str(z1) + '): ' + str(agg1.cal(z1)))
print('SFQ-II (z = ' + str(z2) + '): ' + str(agg1.cal(z2)))
