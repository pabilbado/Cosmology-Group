...
#     z = datapoint[0]
#     d_z = datapoint[1]
cosmo_const.update(w_x = 0)
fig, ax = plt.subplots()
cosmo_const.plot(ax, [0.2,1.7], 0.1)

cosmo_const.update(w_x = 1, at=0.50, tau=0.33, wp=0, wm=0, wf=-1)
cosmo_const.plot(ax, [0,1.7], 0.1)
cosmo_const.update(w_x = 1, at=1, tau=0.33, wp=0, wm=0, wf=-1)
cosmo_const.plot(ax, [0.2,2], 0.1)
ax.set_xlabel(r'$z$')
